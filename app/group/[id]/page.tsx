  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className='w-max gap-1 md:gap-4 flex flex-row items-center justify-center'>
        <Link href="/expense">
        <Button className="bg-purple-600 hover:bg-purple-700 text-white flex items-center justify-center p-2 rounded-lg shadow mb-4">
